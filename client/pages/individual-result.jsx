...
export default class IndividualResult extends React.Component {
  ...
  render() {
    ...
    const result = this.state.product._embedded.events[0];
    let newTimeString = '';
    const newTime = [];
    const newDate = [];
    ...
    if (result.seatmap) {
      return (
        <div className='activity-results-container'>
          ...
          <div className='result'>
            <img className='image-top' src={result.images[0].url} alt="image" />
            <img className='image-bottom' src={result.seatmap.staticUrl} alt='seatmap' />
          </div>
      ...
      return (
        <div className='activity-results-container'>
          ...
          <div className='result'>
            <img className='image-solo' src={result.images[0].url} alt="image" />
          </div>
          <div className='information'>
            <h2 className='name'>{result.name}</h2>
            <h3 className='venue'>{result._embedded.venues[0].name}</h3>
